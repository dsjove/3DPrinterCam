...
I have not yet run an end to end time-lapse. Creating a timelapse is possible using the Arduino IDE Serial Monitor. The Serial read code does not cooperate well when the serial bus is flooded with data; needs to be reimplemented.
